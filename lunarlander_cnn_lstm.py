...
class Agent(nn.Module):
    def __init__(self, envs):
        ...
        self.network = nn.Sequential(
            layer_init(nn.Conv2d(1, 32, 8, stride=4)),  # Output: [batch_size, 32, 39, 59]
            nn.ReLU(),
            layer_init(nn.Conv2d(32, 64, 4, stride=2)),  # Output: [batch_size, 64, 18, 28]
            nn.ReLU(),
            layer_init(nn.Conv2d(64, 128, 4, stride=2)),  # Output: [batch_size, 128, 8, 13]
            nn.ReLU(),
            nn.Flatten(),
            layer_init(nn.Linear(128 * 10 * 17, 1024)),
            nn.ReLU(),
        )
        # LSTM
